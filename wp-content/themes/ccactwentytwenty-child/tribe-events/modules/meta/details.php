...
<!-- 
		...
		// tribe_meta_event_tags( sprintf( esc_html__( '%s BabyMine:', 'the-events-calendar' ), tribe_get_event_label_singular() ), ', ', true );
		?>
		...
		// Acessible Email
			...
			<dt class="tribe-events-event-url-label"> Accessibility Email: </dt>
			<dd class="tribe-events-event-url"><a href="mailto:<?php echo $additional_fields['Accessibility Email (if applicable)']; ?>"><?php echo $additional_fields['Accessibility Email (if applicable)']; ?></a></dd>
			<!-- <dt>THE LOGO GOES HERE</dt> -->
			<dd></dd>
			<?php endif; ?>
